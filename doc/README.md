...
| [2026-09-25-text-truth-and-vector-search.md](spec/2026-09-25-text-truth-and-vector-search.md) | **文本真值回显**（默认带 grep 结果、渐进披露）+ **向量语义检索**（本地 ONNX，`semantic_search` 由空壳改为真语义） | 待实施 |
